    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ProductManager.getInstance().addTradable(
                    new Order("COD", "TGT", PriceFactory.makePrice(16000), 100, GlobalConstants.BookSide.BUY));
            System.out.println(ProductManager.getInstance().getProductBook("TGT").toString());
            ...
            ProductManager.getInstance().addTradable(
                    new Order("DIG", "TGT", PriceFactory.makePrice(15985), 211, GlobalConstants.BookSide.SELL));
            System.out.println(ProductManager.getInstance().getProductBook("TGT").toString());

            ////////////////////////////////////////////////////////////////////////////
            System.out.println("\n\nStep F) Add a BUY TGT order from user DIG that does not trade");
            TradableDTO t1 = ProductManager.getInstance().addTradable(
                    new Order("DIG", "TGT", PriceFactory.makePrice(15985), 211, GlobalConstants.BookSide.BUY));
            System.out.println(ProductManager.getInstance().getProductBook("TGT").toString());
            ...
            TradableDTO t2 = ProductManager.getInstance().addTradable(
                    new Order("COD", "WMT", PriceFactory.makePrice(6010), 50, GlobalConstants.BookSide.BUY));
            TradableDTO t3 = ProductManager.getInstance().addTradable(
                    new Order("DIG", "WMT", PriceFactory.makePrice(6010), 100, GlobalConstants.BookSide.BUY));
            TradableDTO t4 = ProductManager.getInstance().addTradable(
                    new Order("EST", "WMT", PriceFactory.makePrice(6010), 75, GlobalConstants.BookSide.BUY));
            ProductManager.getInstance().addQuote(
                    new Quote("WMT",
